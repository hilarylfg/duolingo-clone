...
Duolingo Clone — это современная обучающая платформа для изучения языков в стиле Duolingo. Проект реализован на Next.js 16, React 19, TypeScript, TailwindCSS и поддерживает сессионную авторизацию, двухфакторную аутентификацию, подтверждение email, а также полностью адаптивный дизайн.
